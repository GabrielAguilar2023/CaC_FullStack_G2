							...
							<div class="col mt-3">
									<div class="card1 card mb-4 rounded-3 shadow-sm border-success">
										<div class="card-header py-3 text-white bg-success border-success">
											<h4 class="my-0 fw-normal text-center">Inscripción de Orador</h4>
										</div>
										<div class="card-body m-1">
											
								<div class="mt-3">
								
								<p class="text-center mb-3"><b>A la mayor brevedad</b> será contactado por email para confirmar y coordinar su participación en la conferencia.</p>
								<h3 class="text-center m-4" id="tramite"> N° Inscripción: <%=tramite %> </h3>										
